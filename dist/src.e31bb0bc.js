...
function css() {
  ...
  var styleysArr = keys.map(function (key) {
    return "".concat(key, ": ").concat(styles[key]);
  });
  return styleysArr.join(';');
}
...
var TitleBlock = /*#__PURE__*/function (_Block) {
  ...
  _createClass(TitleBlock, [{
    ...
    value: function toHTML() {
      ...
      var content = "<".concat(tag, "> ").concat(this.value, " </").concat(tag);
      return (0, _utils.row)((0, _utils.col)(content), (0, _utils.css)(styles));
    }
  }]);
...
var TextBlock = /*#__PURE__*/function (_Block2) {
  ...
  _createClass(TextBlock, [{
    key: "toHTML",
    value: function toHTML() {
      var p = "<p>".concat(this.value, "</p>");
      var styles = this.options.styles;
      return (0, _utils.row)((0, _utils.col)(p), (0, _utils.css)(styles));
    }
  }]);
...
var ImageBlock = /*#__PURE__*/function (_Block4) {
  ...
  _createClass(ImageBlock, [{
    ...
    value: function toHTML() {
      ...
      var img = "<img src = \"".concat(this.value, "\" alt = ").concat(alt, " style = \"").concat((0, _utils.css)(imageStyles), "\">");
      return (0, _utils.row)(img, (0, _utils.css)(styles));
    }
  }]);
...
}), new _blocks.ColumnsBlock(['Приложение на JS, без использования библиотек', 'узнаешь как работают принципы SOLID и ООП в JS за один курс', 'JAVASCRIPT - это просто, интересно. Научить создавать любые UI своими руками'], {
  styles: {
...
exports.model = model;
},{"./assets/javascript.jpg":"assets/javascript.jpg","./classes/blocks":"classes/blocks.js"}],"../node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
},{"../utils":"utils.js","../classes/blocks":"classes/blocks.js"}],"classes/app.js":[function(require,module,exports) {
"use strict";
